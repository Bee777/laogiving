import Vue from 'vue';
import App from './vue/AppOrganize.vue';
import store from '@store/organizeStore';
import VueRouter from 'vue-router';
import routes from '@route/routesOrganize';
 ...
 * @Route guard
 */
Vue.prototype.$context_name = "app_organize";
