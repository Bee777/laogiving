<template>
    <div>
        ...
        <div :style="getStyles()" id="organize-main-container"
...
<script>
    ...
    import Footer from '@com/Organize/Partial/Footer.vue';

    const Modals = () => import('@com/Organize/Default/Includes/Modals.vue')
    export default {
        name: 'app-volunteer',
        components: {
            Footer,
