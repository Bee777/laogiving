<template>
    <div class="general-from-container is-65">
        <div class="form-represent is-65" :style="`${isFullWidth ? 'width: 100%' : ''};`">
            ...
            <!--Progress bar-->
            <div class="form-represent-top-border form-represent-top-border-z-index"
                 aria-hidden="true">
                <div class="form-represent-top-border-progress"
                    ...
                    <div class="form-represent-top-border-progress-tran-anim is-anim"><span
                        class="form-represent-top-border-progress-tran-anim-spot is-anim"></span>
                    </div>
                                            ...
                                            <div class="section-input-container-inner">
                                                <div class="form-represent-form-container">
                                                    ...
                                                    <content>
                                                        ...
                                                        <div class="field">
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    class="general-input-validate-top"></div>
                                                                <div
                                                    ...
                                                    <button @click="sendContact"
                                                            ...
                                                            class="button-contact is-info is-fullwidth is-large contact-button">
                                                        Contact Us
                                                    </button>
                                                </div>
                                            </div>
