                ...
                <div class="module-canvas">
                    <div class="md-single-grid provider-list">
                        ...
                        <TablePaginate v-model="query"
                                       :searchPlaceholder="'Search by volunteer name, surname, tel or Email'"
                                       :searchButtonText="'Add User'"
                                       :headers="headers"
                                       :notFoundText="'Please make sure you type or spell the volunteer information correctly.'"
                                       :isSearch="isSearch"
                            ...
                            <template slot-scope="{fireEvent, position, data}" slot="action-row-context">
                                <button
                                    @click="openVolunteerProfileTab(data.row.data.id)"
    ...
    export default AdminBase.extend({
        ...
        methods: {
            ...
            createUser() {
                ...
                ft.loading = true;
                this.models.formTop.type = 'volunteer';
            ...
            openVolunteerProfileTab(id) {
                window.open(`/volunteer/me/?active_page=account&user_id=${id}`)
            }
        },
        created() {
