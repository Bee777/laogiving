...
class SponsorResponse implements Responsable
{

    protected $actionType = "get";
    protected $options = [];
    protected $uploadPath = '/assets/images/sponsors/';
    ...
    {
        $fields = ['id', 'name', 'status', 'image', 'description','link', 'created_at', 'updated_at'];
        $request->request->add(['fields' => $fields]);
        $text = $this->options["text"];
        $paginateLimit = $this->options['limit'];
        $data = Sponsor::select($fields);
