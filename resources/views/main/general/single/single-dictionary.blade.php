@extends('layouts.app')
@php
    $url = route('get.home.dictionary.single', $post->id);
    $image_url =  url('/') .'/assets/images/' .$s['website_logo'];
    $title = 'Dictionary translation of ' . $post->japanese . ' - ' . $post->lao . ' | ' . $s['site_name'];
    $description = 'Dictionary translation of ' . $post->japanese . ' - ' . $post->lao . ' on ' . $s['site_name'] . ', Latest Dictionaries on ' . $s['site_name'] . ' | ' .  $s['site_name'];
@endphp

@section('g_description'){!! $description  !!}
@stop
@section('g_keywords'){{ 'Dictionary translation of ' . $post->japanese . ' - ' . $post->lao }}, Dictionaries on {{ $s['site_name'] }}, Latest Dictionaries
@stop
@section('meta_search')
