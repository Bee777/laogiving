            ...
            <div class="module_authentication">
                <div class="module-canvas emails-card-wrapper">
                    <MasterSingleDetailCard
                        ...
                        content: `You can search other member and see their profile, by enter his/her name, surname, email, year of graduated and so on.`}"
                        ...
                        <SearchInput
                            ...
                            searchPlaceholder="Search by member name, surname or member Email"
                                                    ...
                                                    <div class="is-card-body">
                                                        <div class="is-icon-description-row">
                                                            <span class="is-description">
                                                                Email: {{item.email}} <br>
                                                                Date of Birth (Day-Month): {{ item.date_of_birth ? item.date_of_birth : emptyText}}<br>
    ...
    export default UserBase.extend({
        ...
        methods: {
            ...
            getItems() {//get all users
                ...
                if (!this.$utils.isEmptyObject(this.filters)) {
                    this.isSearch = true;//set if user filters
                }
