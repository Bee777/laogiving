                    ...
                    <div class="column is-8 is-offset-2">
                        <div class="blog-header">
                            <div class="blog-header-title">
                                ...
                                <h1 v-else class="title single-blog-title">{{ singlePostsData.news.data.title }}</h1>
                            </div>
                ...
                <div
                    ...
                    <div class="section">
                        <div class="columns is-multiline">
                            <div class="column is-4" v-for="(item, idx) in singlePostsData.news.others" :key="idx">
                                <div class="card card-jaol">
                                    <div class="card-image" @click="getDetail('news', item)">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <a @click="getDetail('news', item)"><p class="s-title is-12">
                                            {{item.title}}</p></a>
